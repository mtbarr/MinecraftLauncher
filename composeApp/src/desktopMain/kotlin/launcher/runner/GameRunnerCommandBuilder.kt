...
object GameRunnerCommandBuilder {
    fun buildCommand(
        ...
        return buildList {
            ...
            add(versionData.minecraftArguments)
    ...
    private fun buildMinecraftArguments(launcherConfig: LauncherConfig, versionData: VersionData): List<String> {
        val replacedArguments = versionData.minecraftArguments
